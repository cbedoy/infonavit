...
// Pure calc functions (ISR_T, calcISR, calcIMSS, calcPMT, buildTable,
// groupByYear, eiToMonths, buildExtrasMap) live in calc.js
...
function recalcCredit(){
  ...
  const extMap=buildExtrasMap(extraPayments,extraIncomes,appliedEIs,n,sm);
